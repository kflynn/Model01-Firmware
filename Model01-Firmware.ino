...
#define BUILD_INFORMATION "M01 yptll'0e5" // M01 flynn-0.2 after translation
#endif
...
#define FLYNN KEYMAP_STACKED ( \
    Key_Escape,           Key_1,                       Key_2,                     Key_3,                   Key_4,                   Key_5,              Key_Tab,           \
    Key_RightBracket,     Key_Q,                       Key_W,                     Key_E,                   Key_R,                   Key_T,              Key_RightBracket,  \
    Key_Backtick,         Key_A,                       Key_S,                     Key_D,                   Key_F,                   Key_G,                                 \
    Key_LeftShift,        Key_Z,                       Key_X,                     Key_C,                   Key_V,                   Key_B,              Key_Backtick,      \
